...
public class gamePanel extends JPanel {
	...
	// can create collection of buttons and find button with gridx,y value to set
	// symbol for player move
	/**
	 * Create the panel.
	 */
	public gamePanel(gameManager game, ai ai) {
		...
		buttonX.put(btnNewButton, Integer.valueOf(0));
		buttonY.put(btnNewButton, Integer.valueOf(0));
		...
		buttonX.put(btnNewButton_3, Integer.valueOf(0));
		buttonY.put(btnNewButton_3, Integer.valueOf(1));
		...
		buttonX.put(btnNewButton_4, Integer.valueOf(0));
		buttonY.put(btnNewButton_4, Integer.valueOf(2));
		...
		buttonX.put(btnNewButton_2, Integer.valueOf(1));
		buttonY.put(btnNewButton_2, Integer.valueOf(0));
		...
		buttonX.put(btnNewButton_5, Integer.valueOf(1));
		buttonY.put(btnNewButton_5, Integer.valueOf(1));
		...
		buttonX.put(btnNewButton_8, Integer.valueOf(1));
		buttonY.put(btnNewButton_8, Integer.valueOf(2));
		...
		buttonX.put(btnNewButton_1, Integer.valueOf(2));
		buttonY.put(btnNewButton_1, Integer.valueOf(0));
		...
		buttonX.put(btnNewButton_6, Integer.valueOf(2));
		buttonY.put(btnNewButton_6, Integer.valueOf(1));
		...
		buttonX.put(btnNewButton_7, Integer.valueOf(2));
		buttonY.put(btnNewButton_7, Integer.valueOf(2));
	...
	/*
	 * clamp value to range min-max to prevent invalid input, EX: 5 becomes max, and
	 * -1 becomes min
	 */
	...
	class makeMove implements MouseListener {
		...
		// when button is clicked progress the game
		@Override
		public void mouseClicked(MouseEvent arg0) {
			if (!board.isEndGame()) {
				// Player
		...
		/* Below must not be commented out due to the way java handles interfaces */
